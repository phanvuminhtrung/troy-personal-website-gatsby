        ...
        <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-start">
          <Nav>
            ...
            <NavDropdown id="nav-dropdown" className="nav-button text-white me-3" title="PROJECTS">
              <NavDropdown.Item as={Link} className="nav-sub-button" to="https://chatbot.troyphan.com/" target="_blank">TROY'S CHATBOT</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-sub-button" to="https://pointpoker.troyphan.com/" target="_blank">POINT POKER</NavDropdown.Item>
